...
schema:
  - "@context": https://schema.org
    ...
    name: Fenêtres sur Loir — Doué-en-Anjou
    ...
    address:
      "@type": PostalAddress
      streetAddress: 7 rue Saint François
      addressLocality: Doué-en-Anjou
      postalCode: "49700"
      addressCountry: FR
---

Depuis plus de deux décennies, **Fenêtres sur Loir** s'engage aux côtés des particuliers et des professionnels du Maine-et-Loire pour concrétiser leurs projets d'habitat. Guidés par l'amour de l'artisanat, la quête de l'excellence et le choix de la proximité, nous franchissons aujourd'hui une nouvelle étape majeure dans le développement de notre entreprise familiale.

Nous sommes particulièrement fiers de vous annoncer l'ouverture de notre **nouvelle agence à Doué-en-Anjou**. Cette implantation au cœur du Saumurois et de la région du Layon répond à une volonté claire : être encore plus proche de vous, pour vous offrir un accompagnement sur-mesure et réactif.
...
Toute l'équipe se réjouit d'avance de vous accueillir dans ce nouveau point de vente pour étudier vos besoins, analyser les spécificités de votre habitation et vous proposer des solutions techniques et esthétiques personnalisées.

<div class="not-prose my-10 rounded-2xl bg-[var(--color-tint)] p-6 sm:p-8">
  <p class="font-display text-xl sm:text-2xl text-[var(--color-fg)]">Fenêtres sur Loir — Doué-en-Anjou</p>
  <p class="mt-3 text-[var(--color-muted)]">📍 <strong>Notre adresse :</strong> 7 rue Saint François, Doué-en-Anjou, 49700</p>
